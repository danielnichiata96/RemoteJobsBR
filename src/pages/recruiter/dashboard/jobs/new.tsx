              ...
              <div className="px-4 py-5 bg-white sm:p-6">
                <div className="grid grid-cols-6 gap-6">
                      ...
                      <div className="flex">
                        ...
                        <div className="ml-3">
                          <p className="text-sm text-blue-700">
                            You must provide either an application URL or email. This platform doesn't host the application process directly - candidates will be redirected to your URL or prompted to send an email.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="col-span-6">
                    ...
                    />
                    <p className="mt-1 text-xs text-gray-500">URL onde os candidatos serão redirecionados para se candidatar (página de carreiras, link do ATS, etc.)</p>
                  </div>
                  ...
                  <div className="col-span-6">
                    ...
                    />
                    <p className="mt-1 text-xs text-gray-500">Endereço de email onde os candidatos podem enviar suas candidaturas</p>
                  </div>
